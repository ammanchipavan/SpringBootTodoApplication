	            ...
	            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
	                ...
	                <div class="row">
	                    <div class="form-group col-md-12">
	                        ...
	                        <div class="col-md-7">
	                            <input type="text" ng-model="ctrl.todo.name" id="uname" class="todoname form-control input-sm" placeholder="Enter your name" required ng-minlength="3"/>
	                        </div>
	                    </div>
	                </div>
	                ...
	                <div class="row">
	                    <div class="form-group col-md-12">
	                        ...
	                        <div class="col-md-7">
	                            <input type="text" ng-model="ctrl.todo.description" id="description" class="form-control input-sm" placeholder="Enter your Description." required ng-pattern="ctrl.onlyIntegers"/>
	                        </div>
	                    </div>
	                </div>
	                ...
	                <div class="row">
	                    <div class="form-group col-md-12">
	                        ...
	                        <div class="col-md-7">
	                            <input type="text" ng-model="ctrl.todo.status" id="status" class="form-control input-sm" placeholder="Enter your Status." required ng-pattern="ctrl.onlyNumbers"/>
	                        </div>
	                    </div>
	                </div>
