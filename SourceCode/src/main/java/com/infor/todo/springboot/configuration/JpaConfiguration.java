package com.infor.todo.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.infor.todo.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.infor.todo.springboot.model" });
