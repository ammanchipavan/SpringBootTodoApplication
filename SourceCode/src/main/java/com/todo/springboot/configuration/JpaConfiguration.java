package com.todo.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.todo.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.todo.springboot.model" });
